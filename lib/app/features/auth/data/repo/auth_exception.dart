...
/// {@endtemplate}
class LogInWithSocialCancel implements Exception {}
...
class LogInWithSocialFailure implements Exception {
  ...
  factory LogInWithSocialFailure.fromCode(String? code) {
    if(!code.isNullOrEmpty()){
      return LogInWithSocialFailure(
        code!.tr,
      );
    }

    return LogInWithSocialFailure('errorPleaseRetry'.tr);
  }
...
class LogInWithPhoneFailure implements Exception {
  ...
  /// Create an authentication message
  /// from a firebase authentication exception code.
  factory LogInWithPhoneFailure.fromCode(String code) {
    switch (code) {
      default:
        return const LogInWithPhoneFailure();
    }
  }
